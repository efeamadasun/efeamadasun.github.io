...
- Keep at least 50 quotes in `_includes/scripts.html` so the rotation has enough variety, and use quotes attributed to known people rather than generic local notes.
